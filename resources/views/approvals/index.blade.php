<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight motion-safe:animate-fade-in-up motion-safe:animate-duration-300 am-motion-safe">
                    ...
                    @if($approvals->count() > 0)
                        ...
                        <div class="space-y-4">
                            @foreach($approvals as $approval)
                                ...
                                <div class="border dark:border-gray-700 rounded-lg p-6 hover:shadow-lg transition-shadow bg-white dark:bg-gray-800 motion-safe:animate-fade-in-up motion-safe:animate-duration-300 am-motion-safe">
