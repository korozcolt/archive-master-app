...
return [
    ...
    */
    'ocr' => [
        'schedule_enabled' => env('DOCUMENT_OCR_SCHEDULE_ENABLED', true),
    ],
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Gobernanza documental (fallback técnico)
    |--------------------------------------------------------------------------
    |
    | Estos valores actúan solo como respaldo cuando la empresa aún no tiene
    | políticas y catálogos persistidos en base de datos. La fuente operativa
    | de verdad debe vivir en tablas por empresa.
    |
    */
    'governance' => [
        'country_code' => env('DOCUMENT_GOVERNANCE_COUNTRY', 'CO'),
        'timezone' => env('DOCUMENT_GOVERNANCE_TIMEZONE', 'America/Bogota'),
        'weekend_days' => [0, 6],
        'access_levels' => [
            'publico',
            'interno',
            'reservado',
            'clasificado_confidencial',
        ],
        'archive_phases' => [
            'gestion',
            'central',
        ...
        'defaults' => [
            ...
            'pqrs_policies' => [
                [
                    'code' => 'peticion_general',
                    'name' => 'Petición general',
                    'legal_basis' => 'Ley 1755 de 2015, artículo 14',
                    'response_term_days' => 15,
                    'warning_days' => [3, 1],
                ],
                [
                    'code' => 'peticion_informacion_documentos',
                    'name' => 'Petición de información y documentos',
                    'legal_basis' => 'Ley 1755 de 2015, artículo 14',
                    'response_term_days' => 10,
                    'warning_days' => [3, 1],
                ],
                [
                    'code' => 'consulta',
                    'name' => 'Consulta',
                    'legal_basis' => 'Ley 1755 de 2015, artículo 14',
                    'response_term_days' => 30,
                    'warning_days' => [5, 2],
                ],
                [
                    'code' => 'queja_reclamo_sugerencia',
                    'name' => 'Queja, reclamo o sugerencia',
                    'legal_basis' => 'Régimen interno parametrizable, con base general en Ley 1755 de 2015',
                    'response_term_days' => 15,
                    'warning_days' => [3, 1],
                ],
            ],
    ...
    /*
    |--------------------------------------------------------------------------
    | Solicitudes de acceso temporal a documentos
    |--------------------------------------------------------------------------
    */
    'access_requests' => [
        'default_hours' => env('DOCUMENT_ACCESS_REQUEST_DEFAULT_HOURS', 24),
    ],
